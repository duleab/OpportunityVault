...
internship announcement, fellowship, or a list containing multiple opportunities.
...
Be thorough — extract every piece of information available for EVERY opportunity found in the text.
Return this exact JSON structure containing an array of opportunities:
{
  "opportunities": [
    {
